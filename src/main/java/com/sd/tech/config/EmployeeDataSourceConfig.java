...
@EnableJpaRepositories(
        ...
        basePackages = { "com.sd.tech.repository.emp" })  
public class EmployeeDataSourceConfig{  
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(org.springframework.boot.orm.jpa.EntityManagerFactoryBuilder builder, @Qualifier("employeeDatasource")  DataSource dataSource)
    {
        ...
        return builder.dataSource(dataSource)  
            .properties(jpaProps)  
            .packages("com.sd.tech.entity.emp")  
